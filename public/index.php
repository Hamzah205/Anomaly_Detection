...
// Router - handle different routes
require_once __DIR__ . "/router.php";

// If router handled the request, it will exit
// Otherwise, continue rendering landing page below
?>
<!DOCTYPE html>
...
<head>
  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    [data-theme="dark"] .nav-hamburger span { background: var(--text-1); }
...
<body>
  ...
  <nav class="navbar">
    <div class="nav-container">
      ...
      <div class="nav-links">
        ...
        <a href="<?= url('/dashboard1') ?>" class="btn-nav">
          Mulai Analisis
    ...
    <div class="hero-container">
      <div class="hero-content">
        ...
        <div class="hero-buttons">
          <a href="<?= url('/dashboard1') ?>" class="btn-primary">
  ...
  <section class="cta">
    <div class="container">
      <div class="cta-box">
        ...
        <a href="<?= url('/dashboard1') ?>" class="cta-btn">
          <svg><use href="#icon-play"/></svg>
  ...
  <script>
    ...
    (function() {
      ...
      if (!hb || !mm || !ov) return;
      const close = () => { hb.classList.remove('open'); mm.classList.remove('open'); ov.classList.remove('open'); };
