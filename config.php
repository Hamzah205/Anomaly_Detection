 ...
 * Konfigurasi utama: Python + MySQL + Path sistem
 */
...
define('JSON_DIR',      __DIR__ . DIRECTORY_SEPARATOR . 'json'   . DIRECTORY_SEPARATOR);
...
foreach ([DATA_DIR, JSON_DIR, __DIR__ . DIRECTORY_SEPARATOR . 'logs'] as $dir) {
